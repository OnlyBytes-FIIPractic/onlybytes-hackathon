                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:w-[45rem] w-[90vw] bg-surface-darkest shadow-lg p-5 rounded-lg">
                    <div className='flex flex-col gap-6'>
                        <div>
                            ...
                            {capsuleData.open ? <img src="../../../public/img/capsule_opened.png" alt="placeholder" className='mx-auto w:[15rem] h:[15rem] md:w-[20rem] md:h-[20rem] mt-8' /> : <img src="../../../public/img/capsule_image.png" alt="placeholder" className='mx-auto w:[15rem] h:[15rem] md:w-[20rem] md:h-[20rem] mt-8' />}
